    ...
    <div class="panel panel-heading contenedor">
        ...
        <div class="informacion">
            <div class="informacion-general">
                ...
                <span id="totaliva" class="infor" hidden><span class="dat"><?= Html::encode(Yii::$app->formatter->asCurrency(($model->uniforme->precio * $model->cantidad) + ($model->uniforme->precio * $model->cantidad) * ($model->uniforme->iva/100))) ?></span></span>
            </div>
